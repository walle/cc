...
var threateningTests = []struct {
	...
	x   int   // column to place piece
	y   int   // row to place piece
	...
	{2, 2, King, -1, 3, 0}, // Out of bounds
	{1, 1, Rook, 0, 0, 0},
	{2, 2, Rook, 0, 0, 2},
	{10, 10, Rook, 0, 0, 18},
	{10, 10, Rook, 9, 9, 18},
	{10, 10, Rook, 4, 4, 18},
	{2, 2, Rook, -1, 3, 0}, // Out of bounds
	{1, 1, Knight, 0, 0, 0},
	{2, 2, Knight, 0, 0, 0},
	{5, 5, Knight, 2, 2, 8},
	{5, 5, Knight, 4, 4, 2},
	{5, 5, Knight, 0, 0, 2},
	{5, 5, Knight, 2, 0, 4},
	{2, 2, Knight, -1, 3, 0}, // Out of bounds
	{1, 1, Queen, 0, 0, 0},
	{2, 2, Queen, 0, 0, 3},
	{5, 5, Queen, 2, 2, 16},
	{5, 5, Queen, 4, 4, 12},
	{5, 5, Queen, 0, 0, 12},
	{2, 2, Queen, -1, 3, 0}, // Out of bounds
	{1, 1, Bishop, 0, 0, 0},
	{2, 2, Bishop, 0, 0, 1},
	{5, 5, Bishop, 2, 2, 8},
	{5, 5, Bishop, 4, 4, 4},
	{5, 5, Bishop, 0, 0, 4},
	{2, 2, Bishop, -1, 3, 0}, // Out of bounds
}
